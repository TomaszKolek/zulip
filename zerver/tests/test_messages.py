...
class NarrowBuilderTest(AuthedTestCase):
    ...
    def test_add_term_using_stream_operator(self):
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE recipient_id = :recipient_id_1')
    ...
    def test_add_term_using_is_operator_and_private_operand(self):
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE type = :type_1 OR type = :type_2')
    ...
    def test_add_term_using_is_operator_private_operand_and_negated(self):  # NEGATED
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE NOT (type = :type_1 OR type = :type_2)')
    ...
    def test_add_term_using_is_operator_and_non_private_operand(self):
        for operand in ['starred', 'mentioned', 'alerted']:
            ...
            self._do_add_term_test_with_including_where_clause(term, 'WHERE (flags & :flags_1) != :param_1')
    ...
    def test_add_term_using_topic_operator_and_lunch_operand(self):
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE upper(subject) = upper(:param_1)')
    ...
    def test_add_term_using_sender_operator(self):
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE sender_id = :param_1')
    ...
    def test_add_term_using_pm_with_operator_and_not_the_same_user_as_operand(self):
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE sender_id = :sender_id_1 AND recipient_id = :recipient_id_1 OR sender_id = :sender_id_2 AND recipient_id = :recipient_id_2')
    ...
    def test_add_term_using_pm_with_operator_not_the_same_user_as_operand_and_negated(self):  # NEGATED
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE NOT (sender_id = :sender_id_1 AND recipient_id = :recipient_id_1 OR sender_id = :sender_id_2 AND recipient_id = :recipient_id_2)')
    ...
    def test_add_term_using_pm_with_operator_the_same_user_as_operand(self):
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE sender_id = :sender_id_1 AND recipient_id = :recipient_id_1')
    ...
    def test_add_term_using_pm_with_operator_the_same_user_as_operand_and_negated(self):  # NEGATED
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE NOT (sender_id = :sender_id_1 AND recipient_id = :recipient_id_1)')
    ...
    def test_add_term_using_id_operator(self):
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE id = :param_1')
    ...
    def test_add_term_using_search_operator(self):
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE (lower(content) LIKE lower(:content_1) OR lower(subject) LIKE lower(:subject_1)) AND (search_tsvector @@ plainto_tsquery(:param_2, :param_3))')
    ...
    def test_add_term_using_search_operator_and_negated(self):  # NEGATED
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE NOT (lower(content) LIKE lower(:content_1) OR lower(subject) LIKE lower(:subject_1)) AND NOT (search_tsvector @@ plainto_tsquery(:param_2, :param_3))')

    def test_add_term_using_has_operator_and_attachment_operand(self):
        term = dict(operator='has', operand='attachment')
        self._do_add_term_test_with_including_where_clause(term, 'WHERE has_attachment')
    ...
    def test_add_term_using_has_operator_attachment_operand_and_negated(self):  # NEGATED
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE NOT has_attachment')

    def test_add_term_using_has_operator_and_image_operand(self):
        term = dict(operator='has', operand='image')
        self._do_add_term_test_with_including_where_clause(term, 'WHERE has_image')
    ...
    def test_add_term_using_has_operator_image_operand_and_negated(self):  # NEGATED
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE NOT has_image')

    def test_add_term_using_has_operator_and_link_operand(self):
        term = dict(operator='has', operand='link')
        self._do_add_term_test_with_including_where_clause(term, 'WHERE has_link')
    ...
    def test_add_term_using_has_operator_link_operand_and_negated(self):  # NEGATED
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE NOT has_link')
    ...
    def test_add_term_using_in_operator(self):
        ...
        self._do_add_term_test_with_including_where_clause(term, 'WHERE recipient_id NOT IN (:recipient_id_1)')
    ...
    def _do_add_term_test_with_including_where_clause(self, term, where_clause):
        print(self._build_query(term))
